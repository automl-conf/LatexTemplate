...
@book{example_book,
  ...
  year      = {2000},
  title     = {The Definititve Resource},
...
\emph{not} use \TeX{} primitives such as \verb|$$| and \texttt{eqnarray}.  (You
...
To add pseudocode, we suggest the use of the \texttt{algorithm} and
\texttt{algpseudocode} packages, included here. An example algorithm listing (in
a floating \texttt{algorithm} environment) is provided below and in Algorithm
\ref{euclid}.

% from the algorithmicx package documentation by Szász János
\begin{algorithm}
  \caption{Euclid’s algorithm}
  \label{euclid}
  % optional argument controls line numbering; remove to suppress
  \begin{algorithmic}[1]
...
{\color{red} \textbf The following sections must be completed by \emph{all authors.}}

\section{Broader Impact Statement}

\answerTODO{} Please include a broader impact statement regarding the approach,
