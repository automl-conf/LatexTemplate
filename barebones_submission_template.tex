...
% With no package options, the submission will be anonymized,
% and line numbers will be added to the manuscript.
%
...
\section{Example Section} % The Example Section can be removed.
...
% The paper must include a submission checklist. The submission checklist does
% not count towards the page limit and must be included at submission and camera-ready time. 
%
% The following submission checklist is a combination of the NeurIPS '21 checklist:
%
...
\newpage
\appendix
\section{Example Appendix} % The Example Appendix can be removed.
