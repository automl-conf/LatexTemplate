...
% Please include a broader impact statement regarding the approach, datasets and
% applications proposed/used in your paper. It should reflect on the
...
% compensate for it (e.g., if you cannot provide th=e full evaluation code, you
% should at least provide code for a minimal reproducibility of the main
% insights of your paper).
%
% Please do not modify the questions and only use the provided macros for your
% answers. Note that this section does not count towards the page limit. In your
% paper, please delete this instructions block and only keep the Checklist
