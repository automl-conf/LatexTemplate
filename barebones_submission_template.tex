...
% As stated in the call for papers, the 9 pages allocated for the main paper should 
% include a discussion of limitations and a broader impact statement regarding the 
% approach, datasets and applications proposed/used in your paper. It should reflect 
% on the environmental, ethical and societal implications of your work. The statement
